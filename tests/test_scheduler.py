    ...
    def check_over_configs(self, time_step=0, **config):
        ...
        for scheduler_class in self.scheduler_classes:
            ...
            if scheduler_class == VQDiffusionScheduler:
                ...
                residual = model(sample, time_step, num_embed)
            else:
    ...
    def test_from_pretrained_save_pretrained(self):
        ...
        for scheduler_class in self.scheduler_classes:
            ...
            if scheduler_class == VQDiffusionScheduler:
                ...
                sample = self.dummy_sample(num_embed)
                model = self.dummy_model()
                residual = model(sample, timestep, num_embed)
            else:
                sample = self.dummy_sample
                residual = 0.1 * sample
    ...
    def test_step_shape(self):
        ...
        for scheduler_class in self.scheduler_classes:
            ...
            if scheduler_class == VQDiffusionScheduler:
                ...
                sample = self.dummy_sample(num_embed)
                model = self.dummy_model()
                residual = model(sample, timestep_0, num_embed)
            else:
                sample = self.dummy_sample
                residual = 0.1 * sample
...
class VQDiffusionSchedulerTest(SchedulerCommonTest):
    ...
    def dummy_model(self):
        def model(sample, t, num_embed, *args):
