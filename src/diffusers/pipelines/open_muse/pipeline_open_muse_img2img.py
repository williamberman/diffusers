...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> import torch
        >>> from diffusers import OpenMuseImg2ImgPipeline
        >>> from diffusers.utils import load_image

        >>> pipe = OpenMuseImg2ImgPipeline.from_pretrained(
...
class OpenMuseImg2ImgPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        latents = self.scheduler.add_noise(latents, self.scheduler.timesteps[start_timestep_idx], generator=generator)
