...
class AmusedImg2ImgPipelineSlowTests(unittest.TestCase):
    def test_amused_256(self):
        pipe = AmusedImg2ImgPipeline.from_pretrained("openMUSE/diffusers-pipeline-256")  # TODO change
    ...
    def test_amused_512(self):
        pipe = AmusedImg2ImgPipeline.from_pretrained("openMUSE/diffusers-pipeline")  # TODO change
        pipe.to(torch_device)
