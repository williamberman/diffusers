    ...
    def __call__(
        ...
        **kwargs,
        ...
        if prompt_embeds is not None:
            ...
            prompt_embeds = prompt_embeds.to(dtype=self.bert.dtype, device=self.device)
        ...
        for i, t in enumerate(self.progress_bar(self.scheduler.timesteps)):
            ...
            noise_pred = self.unet(
                latents_input, t, encoder_hidden_states=context, cross_attention_kwargs=cross_attention_kwargs
            ).sample
            # perform guidance
            if guidance_scale != 1.0:
