...
class SpatialTransformerTests(unittest.TestCase):
    ...
    def test_spatial_transformer_ff_layers_too_few_dim_changes(self):
        ...
        assert e_info.value.args[0] == "Too few dimension changes. FeedForward must have exactly two dimension changing layers (Linear and GEGLU)."
    ...
    def test_spatial_transformer_ff_layers_too_many_dim_changes(self):
        for layer in ["Linear", "GEGLU"]:
            ...
            assert e_info.value.args[0] == "Too many dimension changes. FeedForward must have exactly two dimension changing layers (Linear and GEGLU)."
